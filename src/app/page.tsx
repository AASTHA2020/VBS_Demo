          ...
          <div className="max-w-[1600px] mx-auto space-y-10 sm:space-y-12 md:space-y-14 lg:space-y-16">
            ...
            <div className="grid gap-3 sm:gap-4 md:gap-6 lg:gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
              {[
                ...
                <div
                  key={video.id}
                  className="group relative overflow-hidden rounded-xl sm:rounded-2xl shadow-lg sm:shadow-xl border-2 border-slate-200 hover:border-vbs-red transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 sm:hover:-translate-y-2"
                >
        ...
        >
          <div className="max-w-[1600px] mx-auto space-y-4 sm:space-y-6 md:space-y-8 lg:space-y-12">
            ...
            <div className="relative max-w-4xl mx-auto px-2 sm:px-4">
              {/* Vertical Dashed Line - Through center of icons */}
{/* Vertical Dashed Line - Perfect Center */}
<div className="absolute top-0 bottom-0 left-[36px] sm:left-[40px] md:left-[44px] lg:left-[48px] xl:left-[52px] w-0.5 border-l-2 border-dashed border-gray-300 transform -translate-x-1/2"></div>
              ...
              <div className="space-y-3 sm:space-y-4 md:space-y-5 lg:space-y-6">
                {[
                  ...
                  return (
                    <div key={index} className="relative flex items-start gap-2.5 sm:gap-3 md:gap-4 lg:gap-6">
                      {/* Circular Icon */}
                      ...
                      <div className="flex-1 pt-0 sm:pt-0.5 md:pt-1 lg:pt-2">
                        <p className="text-[9px] sm:text-[10px] md:text-xs lg:text-sm font-semibold uppercase tracking-wider text-gray-500 mb-0.5 sm:mb-1 md:mb-1.5">
                          {item.step}
                        </p>
...
function ModelCard({ title, description, isRecommended = false, recommendedFor, icon: Icon }: ModelCardProps) {
  return (
    <div className="group relative flex flex-col gap-3 sm:gap-4 rounded-2xl p-4 sm:p-6 md:p-8 border-2 bg-gradient-to-br from-vbs-red/5 via-white to-vbs-red/5 border-vbs-red/40 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 hover:scale-[1.01] overflow-hidden">
      ...
      {Icon && (
        <div className="flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 rounded-2xl bg-gradient-to-br from-vbs-red via-red-600 to-vbs-red shadow-lg group-hover:scale-110 transition-transform duration-300">
      ...
      <div className="space-y-3 relative z-10">
        ...
        {recommendedFor && (
          <p className="text-xs sm:text-sm font-semibold text-vbs-red uppercase tracking-wider">
            {recommendedFor}
          </p>
        )}
      ...
      <div className="absolute bottom-0 left-0 right-0 h-1 bg-vbs-red opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
    </div>
  );
}
